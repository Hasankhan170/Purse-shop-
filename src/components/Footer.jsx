...
>
  ...
  <div className="max-w-7xl mx-auto px-6 lg:px-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 relative z-10">
    ...
    <div>
      ...
      <div className="flex flex-col space-y-2">
        <Link to="/about" className="hover:text-soft-gold transition">About Us</Link>
        <Link to="#" className="hover:text-soft-gold transition">FAQs</Link>
        <Link to="/contact" className="hover:text-soft-gold transition">Contact Us</Link>
        <Link to="/products" className="hover:text-soft-gold transition">Products</Link>
        <Link to="#" className="hover:text-soft-gold transition">Press & Blog</Link>
        <Link to="#" className="hover:text-soft-gold transition">Terms & Conditions</Link>
      </div>
    </div>
    ...
    <div>
      ...
      <div className="flex flex-col space-y-2">
        <Link to="#" className="hover:text-soft-gold transition">Help Center</Link>
        <Link to="#" className="hover:text-soft-gold transition">Privacy Policy</Link>
        <Link to="#" className="hover:text-soft-gold transition">Installment Plan</Link>
        <Link to="#" className="hover:text-soft-gold transition">E-Warranty Activation</Link>
      </div>
    </div>
  ...
  {/* Bottom Footer */}
  <div className="bg-pure-black/30 mt-10 py-4 relative z-10">
